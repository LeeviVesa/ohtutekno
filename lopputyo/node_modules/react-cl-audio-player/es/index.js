...
var AudioPlayer = (_temp = _class = function (_PureComponent) {
  ...
  AudioPlayer.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      React.createElement('div', { className: coverClass, style: { backgroundImage: 'url(' + (currentSong.cover || '') + ')' } }),
      React.createElement(
        'div',
      ...
      React.createElement(
        ...
        React.createElement('span', { className: 'player-progress-value', style: { width: progress + '%' } })
      ),
      React.createElement(
        'div',
