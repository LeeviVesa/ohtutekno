...
var AudioPlayer = (_temp = _class = function (_PureComponent) {
  ...
  AudioPlayer.prototype.render = function render() {
    ...
    var coverClass = (0, _classnames2.default)({
      'player-cover': true,
    ...
    var volumeClass = (0, _classnames2.default)({
      'fa': true,
      'fa-volume-up': !mute,
      'fa-volume-off': mute
    });

    var randomClass = (0, _classnames2.default)({
      'player-btn small random': true,
      'active': random
    });

    var repeatClass = (0, _classnames2.default)({
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement('div', { className: coverClass, style: { backgroundImage: 'url(' + (currentSong.cover || '') + ')' } }),
      ...
      _react2.default.createElement(
        'div',
        { className: 'player-progress-container', onClick: function onClick(e) {
            return _this2.setProgress(e);
          } },
        _react2.default.createElement('span', { className: 'player-progress-value', style: { width: progress + '%' } })
      ),
      _react2.default.createElement(
        'div',
